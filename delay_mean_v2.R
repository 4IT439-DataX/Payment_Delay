...
data_collection_delay = data_collection_delay[,-25] #sorted by delay_21_y == 1, factor is not needed anymore
...
data_collection_delay <- sample_n(data_collection_delay, size = 50000) 
...
#results for 50000 rows
#alpha lambda   rmse_ho   rmse_cv
#1       0      0 0.2091761 0.2106943
#1.1     0      0 0.2091761 0.2106943
