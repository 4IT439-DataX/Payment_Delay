...
For the Elastic net regression, hypergrid was again defined to tune the parameters. We decided to use hold-out method as well as 10-fold cross-validation to find the optimal values of hyper parameters as in the first model. Results can be found in the table below.
...
```{r correlogramPairs, echo=FALSE, fig.cap="\\label{fig:corrPairs} Top 15 most correlated variables. ", out.width = '90%'}
knitr::include_graphics("top15_correlation.jpg")
```
